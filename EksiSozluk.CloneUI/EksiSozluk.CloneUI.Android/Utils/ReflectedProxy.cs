...
namespace EksiSozluk.CloneUI.Droid.Utils
{
    public class ReflectedProxy<T> where T : class
    {
        ...
        public object Call([CallerMemberName] string methodName = "", object[] parameters = null)
        {
            ...
            {
                _cachedMethodInfo[methodName] =
                    _targetMethodInfoList.Single(mi => mi.Name == methodName || mi.Name.Contains("." + methodName));
            }
        ...
        PropertyInfo GetPropertyInfo(string propertyName)
        {
            ...
            {
                _cachedPropertyInfo[propertyName] =
                    _targetPropertyInfoList.Single(pi => pi.Name == propertyName || pi.Name.Contains("." + propertyName));
            }
